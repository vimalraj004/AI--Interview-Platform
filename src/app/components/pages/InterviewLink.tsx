    ...
    <div className="">
      ...
      <div className="bg-white p-5 rounded-xl mt-2">
        <div className="flex justify-between">
          ...
          <p className="rounded-xl text-primary bg-blue-200 text-sm p-1 px-2">
            Valid for 30 Days
          </p>
        </div>
        ...
        <div className="flex justify-evenly mt-5">
          <h2 className="text-sm text-gray-7  00 flex gap-2 items-center">
      ...
      <div className="bg-white rounded-xl mt-2 p-5">
      ...
      <div className="bg-white rounded-xl mt-2 p-5 flex gap-2 justify-between">
        <Button variant={"outline"} className="bg-primary text-white  flex">
